<div class="container py-6">
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Crear un nuevo cliente</h2>
        </div>
    </x-slot>
    ...
    <x-jet-form-section class="mb-6" submit="save">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-3">
                ...
                <x-jet-input wire:model.defer="createForm.cuit" type="number" class="w-full"
