    ...
    <x-jet-dialog-modal wire:model="isOpen">
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                ...
                <x-jet-input wire:model="editForm.name" type="text" class="w-full" placeholder="Ingrese el nombre de la localidad"></x-jet-input>
            ...
            <div class="mb-4">
                ...
                <x-jet-input wire:model="editForm.postal_code" type="text" class="w-full" placeholder="Ingrese el código postal de la localidad"></x-jet-input>
