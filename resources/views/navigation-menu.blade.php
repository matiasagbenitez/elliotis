                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="ml-3 relative flex items-center">
                        <x-jet-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-jet-dropdown-link href="{{ route('admin.countries.index') }}" :active="request()->routeIs('admin.countries.index')">
                                    {{ __('Países') }}
                                </x-jet-dropdown-link>
                    ...
                    <div class="ml-3 relative flex items-center">
                        <x-jet-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-jet-dropdown-link href="{{ route('admin.iva-conditions.index') }}">
                                    {{ __('Condiciones ante IVA') }}
                                </x-jet-dropdown-link>

                                <x-jet-dropdown-link href="{{ route('admin.iva-types.index') }}">
                                    {{ __('Tipos de IVA') }}
                                </x-jet-dropdown-link>
                    ...
                    <div class="ml-3 relative flex items-center">
                        <x-jet-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                <x-jet-dropdown-link href="{{ route('admin.measures.index') }}">
                                    {{ __('Medidas') }}
                                </x-jet-dropdown-link>

                                <x-jet-dropdown-link href="{{ route('admin.unities.index') }}">
                                    {{ __('Unidades') }}
                                </x-jet-dropdown-link>
                    ...
                    <div class="ml-3 relative flex items-center">
                        <x-jet-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-jet-dropdown-link href="{{ route('admin.pucharse-parameters.index') }}" :active="request()->routeIs('admin.pucharse-parameters.index')">
                                    {{ __('Parámetros de compras') }}
                                </x-jet-dropdown-link>
                                <x-jet-dropdown-link href="{{ route('admin.purchases.index') }}" :active="request()->routeIs('admin.purchases.index')">
                                    {{ __('Compras') }}
                                </x-jet-dropdown-link>
                            </x-slot>
